...
__truediv__(self, a:float) -> Vector
...
class Vector():
    ...
    def __add__(self, other:Vector) -> Vector:  # Vector + Vector
    ...
    def __sub__(self, other:Vector) -> Vector:  # Vector - Vector
        new_x = self.x - other.x
        new_y = self.y - other.y
        return Vector(new_x, new_y)

    def __mul__(self, a:float) -> Vector:  # Vector * a
    ...
    def __truediv__(self, a:float) -> Vector:  # Vector / a
        new_x = self.x / a
        new_y = self.y / a
        return Vector(new_x, new_y)
...
res = eva + john  # we add their force vectors together
